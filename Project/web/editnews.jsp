<%-- 
    Document   : editnews
    Created on : May 18, 2023, 9:16:25 AM
    Author     : myth
--%>
                        ...
                        <div class="container-sm flex-grow-1 container-p-y">
                            ...
                            <div class="card">
                                <form action="editnews" method="post" enctype="multipart/form-data">
                                    ...
                                    Title<input type="text" name="title" style="width: 100%;" value="${data.getTitle()}"><br><br>
                                    <!--                                    <label for="imageUrl">Thumbnail(Enter URL):</label>
                                                                        <input type="text" id="imageUrl" name="imageUrl" >-->
                                    <label for="title">Summary:</label>
                                    <textarea type="text" name="summary" id="summary"  required style="width: 100%;">${data.getSummary()}</textarea><br><br>
                                    <label for="thumbnail">Thumbnail:</label>
                                    <input type="file" name="thumbnail" id="thumbnail" onchange="previewImage(this);">
                                    <input hidden="" name="oldImg" value ="${data.getImage()}">
                                    <img  style="width: 100px;height: 100px;object-fit: fill;" id="preview" src="uploads/${data.getImage()}" alt="Preview" />
                                    ...
                                    <textarea id="editor_text" name="editor_text">${data.getContent()}</textarea>
                                    <div>
