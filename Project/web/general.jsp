...
<%-- 
    Document   : general
    Created on : Jun 2, 2023, 11:32:28 PM
    Author     : CAT PHUONG
--%>
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-sm flex-grow-1 container-p-y">
                            <a class="btn btn-light text-capitalize border-0" data-mdb-ripple-color="dark" href="general" style="color: #8789FF;"><i
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                ...
                                <h6><a class="mb-6" href="saleRedirect?mode=4" style="color: #8789FF;">Show All </a></h6>
                            </div>
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            ...
                                            <c:forEach items="${requestScope.orders}" var="item">
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-sm btn-primary" href="saleRedirect?mode=9&id=${item.getOrderID()}">Detail</a></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
