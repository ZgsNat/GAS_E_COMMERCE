<%-- 
    Document   : WarrantyInfo
    Created on : Jun 15, 2023, 12:56:31 AM
    Author     : minhn
--%>
...
<html
    ...
    <head>
        ...
        <title>Warranty - Export/Print</title>
                ...
                <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                    <div class="app-brand demo">
                        <a href="general" class="app-brand-link">
                            ...
                            <span class="app-brand-text menu-text fw-bolder" style="border-width:1px; border-style:solid; border-color:#696cff; padding: 5px; font-family: 'Mukta';color: #696cff; font-weight: 50; font-size: 30px"> GAS VIETNAM </span>                        </a>
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-fluid pt-4 px-4">
                            ...
                            <a class="btn btn-light text-capitalize border-0" data-mdb-ripple-color="dark" href="saleRedirect?mode=9&id=<%=invoiceId%>"><i
                                    class="fas fa-money-bill text-primary"></i> Invoice</a>
                            <a class="btn btn-light text-capitalize border-0" data-mdb-ripple-color="dark" href="saleRedirect?mode=5&orderId=<%=invoiceId%>" style="color:#8789FF;"><i
                                    class="fas fa-scroll text-primary"></i> Warranty</a>
                            <a class="btn btn-light text-capitalize border-0" data-mdb-ripple-color="dark" href="saleRedirect?mode=6&orderId=<%=invoiceId%>"><i
                                ...
                                <div class="card-body" id="invoice">
                                    <div class="container mb-5 mt-3">
                                        <div class="row d-flex align-items-baseline">
                                            <div class="col-xl-11">
                                                <h1 style="color: #7e8d9f;font-size: 20px;">WARRANTY</h1>
                                            </div>
                                            <hr>
                                        </div>
                                        ...
                                        <div class="container">
                                                ...
                                                <table class="table table-striped table-borderless">
                                                    <thead style="background-color:#8789FF ;" class="text-white">
                                                        <tr>
                                                            ...
                                                            <th scope="col" style="color: whitesmoke">Purchase Date</th>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-8">
                                                    <p> <h4 style="color:#8789FF ;">Điều kiện bảo hành:</h4>
                                                    + Sản phẩm còn trong thời hạn bảo hành được tính kể từ ngày giao hàng hoặc được ghi trên phiếu bảo hành <br>

                                                    + Có Phiếu bảo hành của nhà sản xuất hoặc nhà phân phối<br>

                                                    + Không mắc phải những lỗi dưới đây<br>

                                                    <h4 style="color:#8789FF ;">Các trường hợp không được bảo hành miễn phí</h4>

                                                    +  Không xuất trình phiếu bảo hành khi sửa chữa<br>

                                                    +  Các thông tin trên phiếu bảo hành không đầy đủ, không trùng khớp với sản phẩm thực tế<br>

                                                    +  Lỗi do vận chuyển, thiên tai, do sử dụng hóa chất, hoặc sản phẩm bi rơi đổ, va đâp do tác động
                                                    lực từ bên ngoài<br>

                                                    + Lỗi do tự ý lắp đặt, sử dụng, bảo quản không đúng cách; không tuân theo sách hướng dẫn hoặc các
                                                    các cảnh báo thể hiện trên sản phẩm<br>

                                                    + Lỗi hao mòn tư nhiên khi sử dung hoặc do điều kiện môi trường nơi đặt sản phẩm không phù
                                                    hợp<br>

                                                    + Lỗi do tự ý tháo gỡ hoăc thay đổi kết cấu sản phẩm</p>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            <div class="col-xl-10">
                                                <p>Sau thời gian bảo hành khách hàng phải thanh toán chi phí cho nhà sản xuất</p>
                                            </div>
                                        </div>
