<%-- 
    Document   : FixHistoryList
    Created on : Jun 15, 2023, 1:51:17 PM
    Author     : minhn
--%>
            ...
            <div class="layout-container">
                ...
                <div class="layout-page">
                    ...
                    <div class="container-fluid pt-4 px-4">
                        ...
                        <a class="btn btn-light text-capitalize border-0" data-mdb-ripple-color="dark" href="saleRedirect?mode=8"><i
                                class="fas fa-money-bill text-primary"></i> Order Management</a>
                        <a class="btn btn-light text-capitalize border-0" data-mdb-ripple-color="dark" href="saleRedirect?mode=7" style="color: #8789FF;"><i
                                class="fas fa-money-bill text-primary"></i> Fix History List</a>
                        <div class="bg-light text-center rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <h6 class="mb-0">Product Fix History</h6>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${requestScope.warranty}" var="item">
                                            <tr>
                                                ...
                                                <td>${item.getProductSeries()}</td>
                                                <td>${item.getCustomerName()}</td>
                                                <td>${item.getPurchaseDate()}</td>
                                                <td>${item.getModifiedDate()}</td>
                                                <td><a class="btn btn-sm btn-primary" href="saleRedirect?mode=12&series=${item.getProductSeries()}&productId=${item.getProductId()}&orderId=${item.getOrderId()}&productName=${item.getProductName()}">Details</a></td>
                                                <td><a class="btn btn-sm btn-primary" href="saleRedirect?mode=14&series=${item.getProductSeries()}&orderId=${item.getOrderId()}&productId=${item.getProductId()}" onclick="return confirm('Are you sure you want to delete this item')">Delete</a></td>
                                                <td><a class="btn btn-sm btn-primary" href="saleRedirect?mode=16&series=${item.getProductSeries()}&orderId=${item.getOrderId()}&productId=${item.getProductId()}&customerName=${item.getCustomerName()}">Update</a></td>
                                            </tr>
