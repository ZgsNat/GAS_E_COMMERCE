            ...
            <div class="layout-container">
                ...
                <div class="layout-page">
                    ...
                    <div class="container-fluid pt-4 px-4">
                        ...
                        <a class="btn btn-light text-capitalize border-0" data-mdb-ripple-color="dark" href="AddProductMaintainance.jsp"><i
                                class="fas fa-money-bill text-primary"></i> Create</a>
                                ...
                                <div class="mb-2 col-sm row" >
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" class="form-control" name="search" placeholder="Search Fix History"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-2">
