                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-sm flex-grow-1 container-p-y">
                            ...
                            <div class="card">
                                ...
                                <div >
                                    <div>
                                        <form action="banner?mod=edit&id=${b.getId()}" method="post" enctype="multipart/form-data">
                                            <label for="title">Title:</label>
                                            <input type="text" name="title" id="title" value="${b.getTitle()}" required style="width: 100%;"><br><br>
                                            <label for="banner">Banner:</label>
                                            <input type="file" name="banner" id="banner" onchange="previewImage(this)">
                                            <input hidden="" name="oldBanner" value ="${b.getImage()}">
                                            <img  style="width: 300px;height: 100px;object-fit: fill;" id="preview" src="banner/${b.getImage()}" alt="Preview" /><br><br>
