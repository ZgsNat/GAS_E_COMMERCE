...
<!--        <link href='' rel='stylesheet'>-->
        ...
        <style>
            body {
                ...
                line-height: 1.5;
                text-transform: none;
                background-image: url(Client/Login/images/bg.jpg);
            }
                            ...
                            <div class="form-group">
                                <label for="email-for-pass">Enter your email address</label> <input
                                    ...
                                    <c:if test="${check == false}">
                                        <p style="text-align: center; color: red">Please check your email again!</p>
                                    </c:if>
                            </div>
                        </div>
...
<!--                            <button class="btn btn-danger" type="submit">Back to
                                Login</button>-->
                            <a class="btn btn-danger" href="logincookie">Back to Login</a>
                        </div>
                    </form>
                </div>
            </div>
