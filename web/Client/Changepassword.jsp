                            ...
                            <div class="col-md-8">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-user-information">
                                        <tr>
                                            <td class="glyphicon glyphicon-asterisk text-primary">
                                                New Password: 
                                            </td>
                                            <td>
                                                <input class="text-primary" style="width: 100%" type="password" name="password" required=""> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="glyphicon glyphicon-asterisk text-primary">
                                            ...
                                            <td>
                                                <input class="text-primary" style="width: 100%" type="password" name="confPassword" required="">
                                            </td>
                                        </tr>
                                    </table>
                                    <c:if test="${status=='resetSuccess'}">
                                        <p style="color: red">Update success!</p>
                                    </c:if>
