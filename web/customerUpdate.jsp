        ...
        <div class="layout-wrapper layout-content-navbar">
            <div class="layout-container">
                ...
                <div class="layout-page">
                                            ...
                                            <table class="table table-striped table-borderless">
                                                <thead style="background-color:#8789FF ;" class="text-white">
                                                    <tr>
                                                        ...
                                                        <th scope="col" style="color: whitesmoke">Discount</th>
                                                        <th scope="col" style="color: whitesmoke">Note</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                            ...
                                            <div class="table-responsive">
                                                <form action="crudcustomer" method="post">
                                                    <table class="table text-start align-middle table-bordered table-hover mb-0">
                                                        <thead>
                                                            <tr class="text-dark">
                                                                <th class="col-md-3">CustomerName</th>
                                                                <th class="col-md-3">PhoneNumber</th>
                                                                <th class="col-md-3">DOB</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <c:catch var="CustomerID">
                                                                <tr>
                                                            <input type="text" value="${CustomerID.getCustomerID()}" name="id" hidden>
                                                            <td><input type="text" value="${CustomerID.getCustomerName()}" name="name"></td>
                                                            <td><input type="text" value="${CustomerID.getPhoneNumber()}" name="phone"></td>
                                                            <td><input type="text" value="${CustomerID.getDOB()}" name="dob"></td> 
                                                    ...
                                                    <table class="table text-start align-middle table-bordered table-hover mb-0">
                                                        ...
                                                        <tbody>
                                                            <c:catch var="CustomerID">
                                                                <tr>
                                                                    <td><textarea name="email" cols="10" rows="3" style="width: 100%;word-break: normal;">${CustomerID.getEmail()}</textarea></td>
                                                                    <td><textarea name="adress" cols="10" rows="3" style="width: 100%; height: 100%;">${CustomerID.getAddress()}</textarea></td>
                                                                    <td><textarea name="date" cols="10" rows="3" style="width: 100%;word-break: normal;">${CustomerID.getRegistrationDate()}</textarea></td>
                                                                </tr>
                                                            </c:catch>
                                                        </tbody>
                                                    </table>
                    ...
                    <!--                                <a class="btn btn-sm btn-primary" href="crudcustomer?cID=${item.getCustomerID()}&mod=1">Update</a>-->
                                                </form>    
                                            </div>
                                        </div>
                                    </div>
