<%-- 
    ...
    Created on : Jun 22, 2023, 12:26:16 AM
    Author     : minhn
--%>
                            ...
                            <div class="row">
                                <div class="col-xxl">
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <form action="saleRedirect" method="post" class="row" id="submit" >
                                                <input type="hidden" name="mode" value="17">
                                                <div class="row mb-3">
                                                    <label class="col-sm-2 col-form-label" for="basic-default-name">Customer Name: </label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="basic-default-name" name="cName" placeholder="Enter Customer Name here..."/>
                                                    </div>
                                                </div>
                                                <label class="col-sm-2 col-form-label" for="basic-default-value">Date: </label>
                                                <div class="col-sm-10">
                                                    <input
                                                        type="text" readonly=""
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="basic-default-name" name="phone" placeholder="Enter Phone Number here..."/>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label class="col-sm-2 col-form-label" for="basic-default-name">Address: </label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="basic-default-name" name="address" placeholder="Enter Address here..."/>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label class="col-sm-2 col-form-label" for="basic-default-value">Product Name: </label>
                                                    <div class="col-sm-4">
                                                        <select name="pName" id="cars">
                                                            <c:forEach items="${requestScope.product}" var="item">
                                                                <tr>
                                                                <option value="${item.getProductID()}">${item.getProductName()}</option>                                                              
                                                                </tr>
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="mt-3">
                                                        <button type="submit" class="btn btn-primary" name="addSubmit">Create Order</button><br><br>
                                                        <button type="reset" class="btn btn-primary" name="cancel"><a href=saleRedirect?mode=8>Cancel</a></button>
                                                    </div>
                                                </div>
                                            </form>
                                            <div id="updateError">
