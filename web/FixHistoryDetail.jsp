<%-- 
    Document   : FixHistoryDetail
    Created on : Jun 29, 2023, 2:08:59 AM
    Author     : minhn
--%>
                ...
                <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                    <div class="app-brand demo">
                        <a href="general" class="app-brand-link">
                            ...
                            <span class="app-brand-text menu-text fw-bolder" style="border-width:2px; border-style:solid; border-color:#233446; padding: 5px; font-family: 'Mukta';color: #333; font-weight: 50; font-size: 25px"> GAS VIETNAM </span>                        </a>
                                        ...
                                        <div class="container">
                                            <div class="col-md-12">
                                                <div class="text-center">
                                                    <h1 class="fab fa-mdb fa-4x ms-0" style="color:#8789FF;"><span class="app-brand-text menu-text fw-bolder" style="border-width:2px; border-style:solid; border-color:#233446; padding: 5px; font-family: 'Mukta';color: #333; font-weight: 30; font-size: 40px"> GAS VIETNAM </span></h1>
                                                </div>
                                            </div>
                                            <br><br>

                                            <div class="row">
                                                <a class="text-muted" style="font-size: 18px;">Product Name: <span style="color:#8789FF ;"><%=productName%></span></a>
                                                <div class="col-xl-8">
                                                    <ul class="list-unstyled">
                                                        <br><li class="text-muted" style="font-size: 18px;">Customer Name: <span style="color:#8789FF ;"><%=customerName%></span></li><br>
                                                        <li class="text-muted" style="font-size: 18px;">Address: <span style="color:#8789FF ;"><%=address%></span></li><br>
                                                        <li style="color:#8789FF; font-size: 18px"><i class="fas fa-phone" style="color:#8789FF ;"></i> <%=phone%></li><br>   

                                                    </ul>
                                                </div>
                                                <div class="col-xl-4">
                                                    <ul class="list-unstyled">
                                                        <li class="text-muted" style="font-size: 18px;"><i class="fas fa-circle" style="color:#8789FF ;"></i> <span
                                                                class="fw-bold">Invoice ID:</span> <%=invoiceId%></li><br>
                                                        <li class="text-muted" style="font-size: 18px;"><i class="fas fa-circle" style="color:#8789FF ;"></i> <span
                                                                class="fw-bold">Purchase Date: </span><%=purchaseDate%></li> <br>
                                                        <li class="text-muted" style="font-size: 18px;"><i class="fas fa-circle" style="color:#8789FF ;"></i> <span
                                                                class="fw-bold">Location: </span><%=location%></li> <br>

                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xl-10" style="font-size: 18px;">
                                                    <br><br><br><br>
                                                    <p>Sign:...................................</p>
                                                </div>
                                            </div>       
