                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="d-flex align-items-center ">
                                                        ...
                                                        <a class="edit-button btn-primary btn" href="banner?mod=add"><i class="bi bi-plus-square"></i> ADD</a>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <table class="table text-end-center">
                                                                ...
                                                                <tbody class="test">
                                                                    <c:forEach items="${b}" var="item">
                                                                        <tr>
                                                                            <td>${item.getTitle()}</td>
                                                                            <td><img style="width: 300px;height: 100px;object-fit: cover;" src="banner/${item.getImage()}" alt="Image"></td>
                                                                            <td><span class="badge ${item.getContent() eq 'active' ? "badge-success" : "badge-warning"}" 
                                                                                      onclick="showToClient(this, ${item.getId()})">
                                                                                    ${item.getContent() eq 'active'? "Show" : "Not Show"}
                                                                                </span>
                                                                            </td>
                                                                            ...
                                                                            <td>
                                                                                <div style="display: inline-flex">
                                                                                    ...
                                                                                    <a class="btn btn-icon btn-sm"  href="banner?id=${item.id}&mod=edit">
                                                                                        <i class="bx bx-edit-alt me-1"></i>
                                                                                    </a>
                                                                                    <a class="btn btn-icon btn-sm" href="banner?id=${item.id}&mod=delete" onclick="return confirm('Are you sure you want to delete this item')">
