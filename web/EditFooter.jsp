                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-sm flex-grow-1 container-p-y">
                            ...
                            <div class="card">
                                ...
                                <div >
                                    <div>
                                        <form action="HFM?mod=EditFooter" method="post">
                                            <input type="hidden" name="id" value="${f.id}">
                                            <label for="title">Title:</label>
                                            <input type="text" name="title" id="title" value="${f.title}" required style="width: 100%;"><br><br>
                                            <label for="title">Summary:</label>
                                            <textarea type="text" name="summary" id="summary" required style="width: 100%;">${f.getSummary()}</textarea><br><br>
                                            
                                            <label for="Category">Category</label>
                                            <select name="Cate" id="Cate">
                                                <c:forEach items="${cate}" var="item"> 
                                                    <option value=  "${item.getId()}" ${f.getCategoryID()==item.getId()?"selected":""}>${item.getName()}</option>
                                                </c:forEach>
                                            </select><br><br>
                                            <label for="editor_text">Content:</label>
                                            <textarea style="height: 300px !important;" class="editor_text" id="editor_text" name="editor_text">${f.getContent()}</textarea>
