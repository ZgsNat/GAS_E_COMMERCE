                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-sm flex-grow-1 container-p-y">
                            ...
                            <div class="card">
                                ...
                                <div >
                                    <div>
                                        <form action="HFM?mod=EditHeader" method="post" >
                                            <input type="hidden" name="id" value="${h.id}">
                                            <label for="title">Title:</label>
                                            <input type="text" name="title" id="title" value="${h.title}" required style="width: 100%;"><br><br>
                                            <label for="url">Url:</label>
                                            <input type="text" name="url" id="url" value="${h.content}" required style="width: 100%;"><br><br>
